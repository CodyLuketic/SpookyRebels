...
{
    private BossValues bossValues = null;
    ...
    private void Start()
    {
        ...
        bossValues = gameObject.GetComponent<BossValues>();

        AttackStart(bossValues.GetMelee());
    }
    ...
    private IEnumerator RangedAttack()
    {
        while (true)
        {
            ...
            yield return new WaitForSeconds(bossValues.GetAttackSpeed());
        }
    }
}
